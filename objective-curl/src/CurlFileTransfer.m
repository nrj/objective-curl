...
@implementation CurlFileTransfer
...
{
	NSArray *pathComponents = [NSArray arrayWithObjects:[[NSBundle bundleForClass:[self class]] bundlePath], @"Resources", [CurlFileTransfer emptyFilename], NULL];
