...
//  objective-curl
//  
//  contains custom definitions for curl-connect.patch 
//
...
/* custom callback with current connection status */
...
typedef enum {
  ...
  */
  ...
  /* set a cancelable callback during the connecting process, must point to a 
     curl_connecting_callback */
